---
title: Introduction
description: TokenJam is open-source token economics for AI agents. See where your tokens go, find where they're wasted, and keep agents in line. Local-first, OTel-native, no signup.
